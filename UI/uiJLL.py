...
''' JLL  2023.8.24
for 230822
from /openpilot/tools/replay/ui.py
...
os.environ['BASEDIR'] = BASEDIR
  #--- os.environ = environ({'SHELL': '/bin/bash', ..., 'BASEDIR': '/home/jinn/openpilot'})
...
def ui_thread(addr):
  ...
  camera_surface = pygame.surface.Surface((640, 480), 0, 24).convert()
    ...
    # Bit depth refers to the number of colours that can be displayed by a digital device.
...
if __name__ == "__main__":
  args = get_arg_parser().parse_args(sys.argv[1:])  # $ python uiJLL.py
    # CAN 31 => $ python zc.py 1 2 3 4 => sys.argv[0] == zc.py
    #--- args = Namespace(frame_address=None, ip_address='127.0.0.1')
