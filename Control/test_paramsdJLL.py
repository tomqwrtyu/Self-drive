...
# type: ignore
"""
from /openpilot/selfdrive/debug/internal/test_paramsd.py
JLL 230702
(sconsvenv) jinn@Liu:~/openpilot$ pip3 install seaborn
(sconsvenv) jinn@Liu:~/openpilot$ python test_paramsdJLL.py
--- Error
...
#from laika_repo.examples.kalman.models.car_kf import CarKalman, ObservationKind, States
