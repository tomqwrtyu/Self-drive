# JLL, 2022.7.1
# for /OP079C2/selfdrive/controls/radard.py
# (OP082) jinn@Liu:~/openpilot/common/kalman/tests$ python test_simple_kalman.py
import unittest
import random
import timeit
import numpy as np
...
class TestSimpleKalman(unittest.TestCase):
  ...
  def update_returns_state(self):
    ...
    self.assertEqual(x, self.kf.x)  # No, not equal.
...
kf = KF1D(x0=[[x0_0], [x1_0]],
    ...
    print('#--- kf_speed, kf_old_speed =', kf_speed, kf_old_speed)
