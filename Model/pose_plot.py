"""   YPL, JLL, 2022.2.11 - 3.8, 2023.8.28
from https://github.com/JinnAIGroup/B5/blob/main/bz2toh5_plot.py
for studying
  /home/jinn/dataB6/UHD--2018-08-02--08-34-47--32/global_pose
...
(sconsvenv) jinn@Liu:~/openpilot/aJLL/Model$ python pose_plot.py
"""
import os
import sys
import numpy as np
import matplotlib.pyplot as plt
#import laika_repo.laika.lib.orientation as orient  # OK same
import common.transformations.orientation as orient  # OK same

path = '/home/jinn/dataB6/UHD--2018-08-02--08-34-47--32/'
...
plt.legend()
plt.savefig('pose_plot_path1.png')
plt.show()
'''
