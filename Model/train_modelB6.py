...
from modelB6 import get_model, custom_losses
# from serverB6 import client_generator, STEPS, EPOCHS

# os.environ['CUDA_VISIBLE_DEVICES'] = "0"

# def get_data(hwm, host, port, model):
#   for tup in client_generator(hwm=hwm, host=host, port=port):
#     Ximgs, Xin1, Xin2, Xin3, \
#       Ytrue0, Ytrue1, Ytrue2, Ytrue3, Ytrue4, Ytrue5, Ytrue6, Ytrue7, Ytrue8, Ytrue9, Ytrue10, Ytrue11 = tup
...
if __name__=="__main__":
  ...
  AP.add_argument('--pretrained', '-p', type=str, default=None, help='Pretrained model weights.')
  args = AP.parse_args()

  # Get input train & valid data generator
  no_rnn_state = True
  model_name = "B6.keras" if not no_rnn_state else "B6NRS.keras"
  weights_name = "B6BW.weights.h5" if not no_rnn_state else "B6BWNRS.weights.h5"
  ...
  model = get_model(img_shape, desire_shape, traffic_convention_shape, rnn_state_shape, num_classes, 
